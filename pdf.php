...
$html = '<!DOCTYPE html>
        ...
        <body>
        <table   width="100%">
            <br><h1 style="text-align:center"><b>Quatation</b></h1><br><br><br><br><br>
                    ...
                    <tbody>
                            ...
                            <th width="50%" colspan="3">
                                <span style="font-size:14px"><b>Invoice Id: #001'.$row["qid"].'</b></span> <br>
                                <span style="font-size:14px"><b>Date: '.$row["created_at"].'</b></span> <br>
                                <span style="font-size:14px"><b>Sq Ft.: '.$row["sq_ft"].'</b></span> <br>
